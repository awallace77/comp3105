    ...
    \begin{enumerate}[(c.1)]
      ...
      \begin{table}[h!]
        ...
        \begin{tabular}{|c|c|c|}
          ...
          \hline
        \end{tabular}
        \caption{Different training losses for different models}
      ...
      For training data: \\
      $\begin{bmatrix}
        2.00305568 & 7.31711154 \\
        2.36347873 & 6.6215357
      \end{bmatrix}$ \\[0.15 em]
      For test data: \\[0.15 em]
      $\begin{bmatrix}
        1.66071948 & 5.58874693 \\
        1.9868478 & 5.02664782
      \end{bmatrix}$ \\[0.5 em]
      For a randomly generated training and test data set using seed 101210291, we get the following results: \\[0.5 em]
      For training data: \\
      $\begin{bmatrix}
        0.11160734 & 1.68718399 \\
        0.27832791 & 0.91119205
      \end{bmatrix}$ \\[0.15 em]
      For test data: \\[0.15 em]
      $\begin{bmatrix}
        0.05252988 & 1.02181983 \\
        0.35054548 & 2.26890905
      \end{bmatrix}$ \\[0.15 em]
